...
//	private static String mAccessKey = null;
	...
	public RakutenClient(RakutenClientReceiver receiver) throws ParserConfigurationException, SAXException {
	...
	public void requestHotel(double latitude, double longitude, double range) throws SAXException, IOException {
		Log.v(LOG_TAG, "request Hotels.");
		String request = new String(API_URI + DEV_ID + OPERATION + VERSION +
									LATITUDE + latitude + LONGITUDE + longitude + SEARCHRADIUS + range + DATUMTYPE);
	...
	class HotelHandler extends DefaultHandler {
		...
		public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
			Log.d(LOG_Hotel,"startElment:uri="+uri.toString()+", " +
					"localName="+localName+", qName="+qName+",attributes length="+attributes.getLength());
		...
		public void endElement(String uri, String localName, String qName){
			Log.d(LOG_Hotel,"endElement:uri="+uri.toString()+", localName="+localName+", qName="+qName);
			if (localName.equals("hotel")){
				mInfoList.add(mInfo);
			}else if (localName.equals("recordCount")) {
